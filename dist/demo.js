...
/***/ function(module, exports, __webpack_require__) {
	...
	var Slide = __webpack_require__(2);
	...
	var Demo = (function (_React$Component) {
	    ...
	    _createClass(Demo, [{
	        key: 'handleSlideEnd',
	        value: function handleSlideEnd(o) {
	            console.log(o);
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            ...
	            return React.createElement(
	                ...
	                React.createElement(Slide, { list: this.state.slideList,
	                ...
	                React.createElement(Slide, { list: this.state.slideList.slice(0, 2),
	                    onSlideEnd: t.handleSlideEnd.bind(t) }),
	                React.createElement(
	                    'h3',
	                    { className: 'tP10' },
	                    '特殊情况2，item数量等于1，不可切换'
	                ),
	                React.createElement(Slide, { list: this.state.slideList.slice(0, 1),
	                    onSlideEnd: t.handleSlideEnd.bind(t) })
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Slide = (function (_React$Component) {
	    ...
	    _createClass(Slide, [{
	         ...
	         */
	        value: function _goto(index, callFromDidMount) {
	            var t = this;
	        ...
	        value: function render() {
	            ...
	            return React.createElement(
	                ...
	                React.createElement(
	                    'div',
	                    { className: 't3D tSlideView' },
	                    t.state.list.map(function (item) {
	                        return React.createElement('div', { ref: 'item' + itemIndex, key: itemIndex++,
