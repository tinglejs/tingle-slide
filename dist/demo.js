	...
	var Demo = (function (_React$Component) {
	    ...
	    _createClass(Demo, [{
	        ...
	        value: function render() {
	            return _react2['default'].createElement(_src.PhotoField, { label: '出生证明', photoUrl: './src/img/demo.png', icon: 'shouji' });
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _tingleIcon = __webpack_require__(6);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Icon = React.createClass({
	    ...
	    render: function render() {
	        ...
	        return React.createElement("i", { className: c });
	    }
	});
